...
public class traffic extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        buttonView = LayoutInflater.from(traffic.this).inflate(R.layout.personal_object_button, null);
    ...
    public void otheraddListView() {
        int btnId = 0;
        HashMap<String, EditText> editMap = new HashMap();
        View view = LayoutInflater.from(traffic.this).inflate(R.layout.personal_object, null); //物件來源
        LinearLayout ll = (LinearLayout) view.findViewById(R.id.ll); //取得personal_object中LinearLayout
